...
echo ""
echo "  支持的 Agent 示例："
echo "    workbuddy   →  npx skills add gsq/telrobot-saas-cli -a workbuddy -g -y"
echo "    qoder       →  npx skills add gsq/telrobot-saas-cli -a qoder -g -y"
echo "    cursor      →  npx skills add gsq/telrobot-saas-cli -a cursor -g -y"
echo "    claude-code →  npx skills add gsq/telrobot-saas-cli -a claude-code -g -y"